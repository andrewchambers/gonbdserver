...
const (
	...
	NBD_CMD_FLUSH = 3
	NBD_CMD_TRIM  = 4
	// NBD_CMD_WRITE_ZEROES is 6 per the Linux kernel uapi (and proto.md).
	//
	// This project historically used 5 for WRITE_ZEROES; keep accepting that
	// legacy value for older traces/tests.
	NBD_CMD_WRITE_ZEROES        = 6
	NBD_CMD_WRITE_ZEROES_LEGACY = 5
	NBD_CMD_CLOSE               = 7
)
...
var CmdTypeMap = map[int]uint64{
	...
	NBD_CMD_WRITE_ZEROES_LEGACY: CMDT_CHECK_LENGTH_OFFSET | CMDT_CHECK_NOT_READ_ONLY | CMDT_REQ_FAKE_PAYLOAD,
